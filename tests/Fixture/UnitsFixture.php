...
class UnitsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_custom' => ['type' => 'tinyinteger', 'length' => 3, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_custom' => 1,
                'user_id' => 1,
                'created' => '2018-09-15 08:33:57',
                'modified' => '2018-09-15 08:33:57'
            ],
        ];
        parent::init();
    }
